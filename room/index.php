...
$query = "SELECT * FROM `room` WHERE room.status = 'active'";
...
switch($_POST['sort_week']) {
 case 1:
    $value = 2;
    $query .= "ORDER BY `room`.`id` DESC LIMIT $start_from, $limit";
  break;
 case 0:
  $value = 1;
    $query .= "ORDER BY `room`.`id` ASC LIMIT $start_from, $limit";
  break;
}
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Xonalar</h3>
            ...
            <div class="col-md-6 col-4 align-self-center">
                <div class="text-end upgrade-btn">
                    <a href="create.php" class="btn btn-success d-none d-md-inline-block text-white">Xona Qo'shish</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                                ...
                                <thead>
                                    <tr>
                                        <form name="Table Properties" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <th class="border-top-0" colspan="2">Xona raqami
                                        ...
                                        <th class="border-top-0">Xona haqida</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        foreach ($result as $value) {
                                            echo "<tr>
                                                    <td style='width: 50px'>
                                                        <span class='" . randomColor() . "'>" . getImage('', 'room')."</span>
                                                    </td>
                                                    <td class='align-middle'>
                                                        <h6>" . $value['room_number'] . "</h6>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                <?php
                                $total_pages = getPagination('room');
