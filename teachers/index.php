...
$query = "SELECT * FROM `teacher` WHERE teacher.status = 'active'";
$value = 0;
...
if (isset($_GET["find_name"]) || isset($_GET["find_phone"]) || isset($_GET["find_address"])) {
    ...
    $query = "select teacher.* 
                        from 
                            (select * 
                             from teacher
                             order by firstName desc limit 3) teacher
    ...
    switch ($r) {
        case 1 :
            $value = 0;
            $query = getData('teacher', 'id', 'desc', 3, $start_from);
            break;
        case 0 :
            $value = 1;
            $query = getData('teacher', 'id', 'asc', 3, $start_from);
            break;
    }
} else {
    $query = getData('teacher', 'id', 'desc', 3, $start_from);
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">O'qituvchilar</h3>
            ...
            <div class="col-md-6 col-4 align-self-center">
                <div class="text-end upgrade-btn">
                    <a href="create.php" class="btn btn-success d-none d-md-inline-block text-white">O'qituvchi Qo'shish</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                <?php
                                $total_pages = getPagination('teacher');
