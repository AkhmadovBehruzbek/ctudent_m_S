...
if (isset($_POST['firstName']) && !empty($_POST['firstName']) &&
    ...
    $sql = "insert into teacher (firstName, lastName, phoneNumber, address, image) values (:firstName, :lastName, :phoneNumber, :address, :image)";
    ...
    if ($state->execute()) {
        $host = 'http://' . $_SERVER['HTTP_HOST'] . '/project_1/teachers/index.php';
