...
$sql = "SELECT * FROM course WHERE course.id = $id LIMIT :lim";
$result = selectDataLim($sql, 1);

if (isset($_POST['name']) && !empty($_POST['name']) &&
    isset($_POST['description']) && !empty($_POST['description'])) {
    $sql = "update course set name = :name, description = :description, status=:status where id = :id";
              ...
              <form class="form-horizontal form-material mx-2" method="POST">
                <?php foreach ($result as $value) { ?>
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input name="name" value="<?= $value['name']; ?>" type="text" class="form-control ps-0 form-control-line" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-12 mb-0">Kurs haqida</label>
                    <div class="col-md-12">
                      <input name="description" value="<?= $value['description']; ?>" type="text"  class="form-control ps-0 form-control-line" />
                    </div>
                  </div>
