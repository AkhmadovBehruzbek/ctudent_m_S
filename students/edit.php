...
$sql = "SELECT * FROM students WHERE students.id = $id LIMIT :lim";
...
if (isset($_POST['firstName']) && !empty($_POST['firstName']) &&
    ...
    $sql = "update students set firstName = :first_name, lastName = :last_name, address = :address, phoneNumber=:phone_number, status=:status where id = :id";
        ...
        <div class="col-md-6 col-8 align-self-center">
          ...
          <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/project_1/index.php">Bosh sahifa</a></li>
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
          <div class="card">
            ...
            <?php foreach ($result as $value) { ?>
              <center class="mt-4">
                <img src="<?php echo "./images/" . $value['image'] ?>" class="rounded-circle" width="150" />
                ...
                <div class="row justify-content-center">
                  <div class="col-4">
                    <a href="javascript:void(0)" class="link">
                      ...
                      <span class="font-normal">Rasm o'chirish</span>
                    </a>
                  </div>
                  <div class="col-4">
                    <a href="javascript:void(0)" class="link">
                      ...
                      <span class="font-normal">
                          <form action="editPhoto.php?id=<?=$value['id']?>" method="post" enctype="multipart/form-data">
                              <input name="image" type="file" class="form-control ps-0 form-control-line" placeholder="Rasm" />
