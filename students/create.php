...
if (isset($_POST['firstName']) && !empty($_POST['firstName']) &&
    ...
    $sql = "insert into students (firstName, lastName, phoneNumber, address, image) values (:firstName, :lastName, :phoneNumber, :address, :image)";
    ...
    if ($state->execute()) {
        $host = 'http://' . $_SERVER['HTTP_HOST'] . '/project_1/students/index.php';
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="firstName" type="text" class="form-control ps-0 form-control-line" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12 mb-0">Familiyasi</label>
                                    <div class="col-md-12">
                                        <input name="lastName" type="text" class="form-control ps-0 form-control-line" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="phoneNumber" type="tel" class="form-control ps-0 form-control-line" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="address" type="text" class="form-control ps-0 form-control-line" required />
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-12 mb-0">Rasm kiriting</label>
                                    <div class="col-md-12">
                                        <input name="image" type="file" class="form-control ps-0 form-control-line" />
                                    </div>
                                </div>
